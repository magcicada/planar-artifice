...
dependencies {
    ...
    implementation(fg.deobf(group = "curse.maven", name = "tinkers-construct-74072", version = versionTConstruct))
    implementation(fg.deobf(group = "curse.maven", name = "mantle-74924", version = versionMantle))
